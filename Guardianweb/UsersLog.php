...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Registro diario de usuarios</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Filtro de registros/ Exportar a Excel</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filtrar el registro de usuarios:</h3>
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                        <label for="Start-Time"><b>Seleccione de este tiempo:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Al final de este tiempo:</b></label>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Filtrar por ID de huella digital:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filtrar por departamento:</b></label>
