$(document).ready(function(){
    ...
    $.ajax({
      ...
      success: function(response){
        if (response == "1") {
          ...
          $('#alert').fadeIn(500);
          $('#alert').text("La identificación está lista para obtener una nueva huella digital");
        }
        else{
          $('#alert').fadeIn(500);
          $('#alert').text(response);
    ...
    $.ajax({
      ...
      success: function(response){
        if (response == "1") {
          ...
          $('#alert').fadeIn(500);
          $('#alert').text("Se ha añadido un nuevo usuario!");
        }
        else{
          $('#alert').fadeIn(500);
          $('#alert').text(response);
    ...
    $.ajax({
      ...
      success: function(response){
        if (response == "1") {
          ...
          $('#alert').fadeIn(500);
          $('#alert').text("El usuario seleccionado se ha actualizado!");
        }
        else{
          $('#alert').fadeIn(500);
          $('#alert').text(response);
  ...
  $(document).on('click', '.user_rmo', function(){
    ...
    if (dev_uid === "") {
      $('#alert').fadeIn(500);
      $('#alert').text("No hay ningún usuario seleccionado para eliminar!!");
          ...
          $.ajax({
            ...
            success: function(response){
              if (response == "1") {
                ...
                $('#alert').fadeIn(500);
                $('#alert').text("Se ha eliminado la huella digital del usuario");
              }
              else{
                $('#alert').fadeIn(500);
                $('#alert').text(response);
